...
<div class="container-fluid">
       ...
       <!-- ini page -->
        ...
        <div class="container">
          ...
          <h3 class="alert alert-info text-center">Generador de lista de faltas por fecha:</h3>  
            
          <div class="row">
              
              
           <div class="form-inline col-md-6" >
              <h4> Elija el rango entre fechas y el tipo a continuacion <span class="glyphicon glyphicon-calendar"></span></h4>  
           
              <input type="text" class="datepicker form-control" name="fechaIni" id="fechaIni"  placeholder="Ingrese una fecha"  />
               <span class="alert alert-info">Hasta</span>
               <input type="text" class="datepicker form-control" name="fechaFin" id="fechaFin" placeholder="Ingrese una fecha"/>
               
          </div>
              
              <div class="col-md-3">
                  <label class="alert alert-info">TTE <input type="radio" name="tipo" value="tte" checked class="form-control" id="tipo1"> </label> 
                  <label class="alert alert-danger">TSS <input type="radio" name="tipo" value="tss" class="form-control" id="tipo2"> </label>
               </div>
            <div class="col-md-2">
                <div class="clearfix">
                    &zwnj;
                ...
                <button class="btn btn-lg btn-success" onclick="generarTteList();">Generar lista <span class="glyphicon glyphicon-list-alt"></span></button>
         </div>
       ...
       <div class="container">
           <div class="row alert alert-warning text-center" id="listaTte">
           <br>
           <br>
           <br>
           <h2> Esto esta muy vacio <span class="glyphicon glyphicon-folder-open"></span> </h2>  <small>Eliga un rango de fechas por favor</small>
           <br>
           <br>
           <br>    
       </div>
...
<script src="../js/jquery.fittext.js"></script>
     ...
     function generarTteList()
    {
        ...
        var fechFin=document.getElementById("fechaFin").value;
         ...
         tipos = document.getElementById('tipo1').value;
         }else{
         tipos = document.getElementById('tipo2').value;
        ...
        $.ajax({
            type: 'POST',
            url: url,
            data:{fechaIni:fechIni,fechaFin:fechFin,curso:<?php echo $curso;?>,tipo:tipos},
