	 ...
	 <div class="progress-bar">
	   <div class="progress-bar"><!-- ini page -->       </div>
          ...
          <div class="row text-center">
           ...
           <p></p>
           <button class="btn btn-primary btn-lg" onclick="repday();"><span class="glyphicon glyphicon-log-in" ></span> Planilla General</button>
           <p></p>
           <button class="btn btn-primary btn-lg" onclick="validarRegistro();"><span class="glyphicon glyphicon-log-in" ></span> Resumen Diario</button>
           <p></p>
           <button class="btn btn-primary btn-lg" onclick="validarRegistro();"><span class="glyphicon glyphicon-log-in" ></span> Resumen Cadete</button>
                   <div class="row">
