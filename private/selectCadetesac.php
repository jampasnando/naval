...
$output .=' 
         ...
         $output.= '   <tr>
            ...
            $output.=' <td class="alert alert-success">
             ...
             $output.='   <td>
                       <a href="perfilCadete.php?id_estudiante='.$reg[$index]["id"].'&curso='.$curso.'">
                       ...
                       <a href="anotarFalta.php?id_estudiante='.$reg[$index]["id"].'&curso='.$curso.'"> <button class="btn btn-sm btn-danger">
                        ...
                        <button class="btn btn-sm btn-danger btn_delete" type="button" name="delete_btn" data-id3="'.$reg[$index]["id"].'">
