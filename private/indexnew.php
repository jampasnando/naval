...
body {
	background-image: url(file:///../images/banner4.jpg);
}
    </style>
...
<body>
<div class="label-primary"><img src="../images/logo2.png" alt="Logo" width="156" height="172" class="center-block" style="width:200px;height: 200px">
  <div class="carousel-inner">
    <div class="item active"></div>
    <div class="item"> <a href=""> <img class="img-responsive" alt="Carousel Bootstrap Second" src="../images/banner5.jpg" ></a>
      <div class="carousel-caption">
        <h4></h4>
        <p></p>
      </div>
    </div>
    <div class="item"> <a href="detalleProducto.php"> <img class="img-responsive" alt="Carousel Bootstrap Third" src="../images/banner6.jpg" ></a>
      <div class="carousel-caption">
        <h4></h4>
        <p></p>
      </div>
...
<div class="row text-center">
           ...
           <div class="row">
               <br>
             <button class="btn btn-primary btn-lg" onclick="validarRegistro();"><span class="glyphicon glyphicon-log-in" ></span> Ingresar</button>
           </div>
</div>
       <div class="clearfix">
       &zwj;</div>
<div class="row">
                            <div class="carousel slide" id="carousel-844716"></div>
</div>
       <?php 	
	$directory = "../upload_/";      
