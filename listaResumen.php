  ...
  <table width="780" border="1" cellspacing="0" bordercolor="#CCCCCC" id="tabla">
    <tr bgcolor="#006699">
     <td width="34"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nro</font></div></td>
      ...
      <td width="35"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Jul</font></div></td>
      <td width="44"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nota Jul</font></div></td>
      
      
      <td width="35"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Ago</font></div></td>
          <td width="44"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nota Ago</font></div></td>
   <td width="35"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Sep</font></div></td>
       <td width="44"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nota Sep</font></div></td>
   <td width="35"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Oct</font></div></td>
       <td width="44"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nota Oct</font></div></td>
   <td width="35"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nov</font></div></td>
       <td width="44"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nota Nov</font></div></td>
   <td width="35"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Dic</font></div></td>
        <td width="44"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nota Dic</font></div></td>
    ...
    while ($f=mysql_fetch_row($r))
	{
		...
		echo "<tr ><td>".$n."</td><td><div align='center'><a href='javascript:envia(\"".$f[0]."\",\"".$f[1]."\" ,1);'>".$f[1]."</a></div></td><td>".$f[2]."</td><td><div align='center'><a href='javascript:ver(\"".$f[0]."\",7,1);'>".$f[3]."</a></div></td><td  align='center'".$color.">".$jul."</td><td><div align='center'><a href='javascript:ver(\"".$f[0]."\",8,1);'>".$f[4]."</a></div></td><td width=35 align='center'".$color1.">".$ago."</td><td><div align='center'><a href='javascript:ver(\"".$f[0]."\",9,1);'>".$f[5]."</a></div></td><td align='center'".$color2.">".$sep."</td><td><div align='center'><a href='javascript:ver(\"".$f[0]."\",10,1);'>".$f[6]."</a></div></td><td align='center'".$color3.">".$oct."</td><td><div align='center'><a href='javascript:ver(\"".$f[0]."\",11,1);'>".$f[7]."</a></div></td><td align='center'".$color4.">".$nov."</td><td><div align='center'><a href='javascript:ver(\"".$f[0]."\",12,1);'>".$f[8]."</a></div></td><td align='center'".$color5.">".$dec."</td><td align='center'>".$f[15]."</td><td align='center'".$color6.">".$tot."</td></tr>";$n++;
